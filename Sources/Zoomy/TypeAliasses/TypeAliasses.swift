...
//MARK:  Types
 typealias ImageZoomState = ImageZoomControllerState
 typealias IsNotPresentingOverlayState =
  ImageZoomControllerIsNotPresentingOverlayState
 typealias IsPresentingScrollViewOverlayState =
  ImageZoomControllerIsPresentingScrollViewOverlayState
 typealias IsPresentingImageViewOverlayState =
  ImageZoomControllerIsPresentingImageViewOverlayState
 typealias IsHandlingScrollViewBounceTriggeredDismissalState =
